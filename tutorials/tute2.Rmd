...
We can also show climate change hazards between 2041 and 2060 in submarine canyon

```{r, fig.width=11, fig.height=7}
plot_fun(r=cmip6_2041_2060_exsd %>% subset(1:4) %>% mask(canyon))
```

Similarly, we can show climate change hazards between 2041 and 2060 on seamounts and cold water corals.
